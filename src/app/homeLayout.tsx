    ...
    <div className="flex justify-center">
      <div className="flex flex-col lg:flex-row items-center justify-center">
        ...
        <div className="text-center p-10">
          ...
          <div>
            <span className="whitespace-nowrap"> from crossing the gene sets from Rummagene and RummaGEO. Gene set pairs are sorted by the level of overlap </span>
            <h1>
          ...
          <span className="whitespace-nowrap"> we crossed 748,220 Rummagene sets with 170,612 human RummaGEO sets and 193,939 mouse RummaGEO sets</span>
            ...
            {/* <p> with 158,062 RummaGEO mouse gene sets and 135,264 RummaGEO human gene sets</p> */}
