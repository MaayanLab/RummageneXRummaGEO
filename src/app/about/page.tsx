    ...
    <div className="prose">
      ...
      <div className="flex">
        ...
        <p>Recently, the Ma'ayan Lab developed two new resources: Rummagene and RummaGEO. Rummagene is a web server application that provides access to over 750,000 gene sets extracted from supporting materials of 140,000+ articles after scanning 6 million articles available on PubMed Central. 
         ...
         <p style={{ marginTop: '20px' }}>Since these two new resources produced massive collections of independent annotated gene sets, we sought to cross these two resources to discover gene sets that highly overlap but originate from different seemingly unrelated studies. 
          In total, we compared 748,220  gene sets from Rummagene with 158,062 RummaGEO mouse gene sets and 135,264 RummaGEO human gene sets. This comparison led to the discovery of over 13 million gene set pairs that show high overlap (p-value &lt; 0.001). These 9 million sets are stored in a database and made available for search via the RummagenexRummaGEO website. In addition to providing the overlapping pairs for search, we performed various analyses to characterize the contents within the RummageneXRummaGEO database.</p>
