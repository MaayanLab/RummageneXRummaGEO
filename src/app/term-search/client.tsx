  ...
  return (
    <div className="flex flex-col gap-2 my-2">
      <h2 className="text-md font-bold">
        After rummaging through <Stats show_gene_sets />. RummagenexRummaGEO <Image className="inline-block rounded" src="/images/rummagenexrummageo_logo.png" width={50} height={100} alt="RummagenexRummaGEO"></Image> found your search term in the table titles of {data.geneSetTermSearch?.totalCount} gene sets.
      </h2>
